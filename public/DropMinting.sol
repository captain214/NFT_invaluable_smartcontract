...
contract DropMinting is ReentrancyGuard, Ownable {
    ...
    address public MainwETH = 0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619; // wETH address in Polygon Mainnet
    address public TestwETH = 0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa; // wETH address in Polygon Testnet Mumbai
    ...
    */
     ...
     */
    function dropMint(string[] memory _tokenUri) external nonReentrant returns(uint256 tokenId) {
        ...
        for (uint256 i = 0; i < _tokenUri.length; i++) {
            ...
            IERC20(TestwETH).transferFrom(msg.sender, address(this), price);
